...
describe('convig', function () {
  ...
  it('should give me an appId', function () {
    convig.appId().should.equal('_mocha')
  })
  // yes, we can: just overwrite process.title
  it('should recognize pm2 process titles', function () {
    ...
    process.title = 'pm2/lib/ProcessContainerFork.js-teltonika-tcp'
    convig.appId().should.equal('teltonika-tcp')
  })
